...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_strings = 
{
	...
	toolbar_title : "Bitdefender Antivirus Plus 2012",
...
function bd_nd_E893A5F3FE87409FB167F51A030D021C_ajax(callback)
{
	...
	this.sendRequest = function(params)
	{
		...
		this.ajax.setRequestHeader("BDNDSS_B67EA559F21B487F861FDA8A44F01C50", "10000000b12b23374ed4d2b84ed4dcc8b12b233707c409faf10dca701d66a1d3c54cf673eace4563");
...
var bd_nd_E893A5F3FE87409FB167F51A030D021C_tfHUI = new function () {
	...
	this.updateStatuses = function(status)
	{
		...
		for (var i = 1; i < count; i++)
		{
			...
			buton.className = this.GetID('settings_btn_status') + " " + this.GetID('settings_btn_status') + (feature.status == 1 ? '_on' : '_off') + (status == 1 ? '' : '_unavailable');
		}
	}
    ...
    this.Init = function () {
        ...
        if (that.GetDocHeight() < 62 && window.history.length == 0) {
            return 2;
        }
